/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 419bc5a4146f483f0daab29e11e27643)
// Runtime types generated with workerd@1.20260918.1 2026-09-19 nodejs_compat
interface __BaseEnv_Env {
	LOGIN_RATE_LIMIT: RateLimit;
	ENSURE_SLOTS_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
	SITE_URL: "https://turf-tracking-system.cityarena.workers.dev";
	NEXT_PUBLIC_SUPABASE_URL: string;
	NEXT_PUBLIC_SUPABASE_ANON_KEY: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	NEXT_PUBLIC_SITE_URL: string;
	NEXT_PUBLIC_BUSINESS_TIMEZONE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_BUSINESS_TIMEZONE">> {}
}
